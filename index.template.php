...
<head>
	...
	*/
	...
	template_javascript();
	echo '
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/jquery-1.10.1.min.js"></script>
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/bootstrap.min.js"></script>
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/popper.js"></script>';
...
function template_menu()
{
	...
	echo '
					<ul id="elUserNav" class="dropmenu menu_nav">';
...
function foter_divbox()
{
	global $settings;
	if (!empty($settings['foter_divbox']))
	{
	echo'
